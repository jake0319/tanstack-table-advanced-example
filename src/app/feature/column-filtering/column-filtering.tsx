...
export default function ColumnFilteringTable() {
	...
	// const memoData = useMemo(() => makeData(5_000), []);
	...
	console.log(table.getPageCount(), "pc");
	return (
		<div className="p-2">
			<table>
				<thead>
			...
			<div className="flex items-center gap-2">
				...
				<button
					...
					onClick={() => {
						const newPageIndex = Math.min(1000, table.getPageCount());
...
function Filter({ column }: { column: Column<any, unknown> }) {
	...
	return filterVariant === "range" ? (
		...
		<DebouncedInput className="w-36 border shadow rounded" onChange={value => column.setFilterValue(value)} placeholder={`Search...`} type="text" value={(columnFilterValue ?? "") as string} />
